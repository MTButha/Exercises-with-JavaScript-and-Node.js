...
var personsName = "buTha";

var uppercase = personsName.toUpperCase();
document.write(uppercase + "<br>");

var lowercase = personsName.toLowerCase();
document.write(lowercase + "<br>");

const str = personsName;
...
var message = ("My Favourite Number is " + favoriteNumber + "." + "<br>");
document.write(message);
...
// My Favorite Nmuber Program
var favoriteNumber = 22;
var message = ("My Favourite Number is " + favoriteNumber + "." + "<br>");  // It's My Favorite Number.
document.write(message);
...
var names = ["Afsar", "Iman", "Ibrahim", "Mazhar", "Talha", "Shakeel"];
for (i = 0; i < 5; i++) {
...
var names = ["Afsar", "Iman", "Ibrahim", "Mazhar", "Talha", "Shakeel"];
for (i = 0; i < 5; i++) {
document.write(names[i] + ", let's meets today. <br>");
}
...
var cars = ["Mehran Car", "Alto Car", "Liana Car"];
for (i = 0; i < 3; i++) {
...
document.write(" <br>" + guest[1] + " is not able to join us at dinner.")
...
for (i = 0; i < 3; i++) {
    document.write(" <br>" + guest[i] + " I've found a bigger dinner table");
}
document.write("<br>");

guest.unshift("Mr Talha");
guest.splice(3, 0, "Mr. Shakeel");
guest.splice(7, 0, "Mr. Fasih");
for (i = 0; i < 6; i++) {
    document.write(" <br>" + guest[i] + " I Would like to invite you to dinner tonight." );
}
...
for (i = 0; i < 6; i++) {
document.write("<br>" + guest[i] + ", I can invite only two people for dinner. <br>");
}
for (i = 2; i < 6; i++) {
...
for (i = 0;i < 2; i++) {
    document.write(" <br>" + guest[i] + " I Would like to invite you to dinner tonight.<br>" );
}
...
var worldTour = ["Turkey", "Dubai", "Malaysia", "Singapore", "Qatar"];

document.write(worldTour);
document.write("<br> <br>");

document.write(worldTour.reverse());
document.write("<br> <br>");

document.write("Sorted array: " + worldTour.sort());
document.write("<br> <br>");

document.write("Original array: " + worldTour);
document.write("<br> <br>");

document.write("Reverse array: " + worldTour.reverse());
document.write("<br> <br>");

document.write("Original array: " + worldTour);
document.write("<br> <br>");

document.write("Reverse array to make it original: " + worldTour.reverse());
document.write("<br> <br>");

var alphabeticalOrder = worldTour.sort();
document.write(alphabeticalOrder);
document.write("<br> <br>");

var reverseAlphabeticalOrder = worldTour.reverse();
...
document.write("<br>");
var languagesTop = ["Urdu", "English", "Arabi", "Chines", "Spanish"];
for (i = 0; i < 5; i++) {
    document.write(languagesTop[i] + "<br>");
}
...
const countryUAE = {capital: "Abu Dhabi", LargestCity: "Dubai", language: "Arabic"};
console.log(countryUAE);
...
console.log(car === 'subaru');
console.log(car != 'subaru');
console.log(countryUAE.capital === "Abu Dhabi");
console.log(countryUAE.capital === "AbuDhabi");
console.log(countryUAE.LargestCity === "Dubai");
console.log(countryUAE.LargestCity === "Abu Dhabi");
console.log(countryUAE.language === "Arabic");
console.log(countryUAE.language === "arabic");
document.write("<br> <br>");
...
console.log("this is a test for string" == "This is a test for string");
console.log("This is a test for string" == "This is a test for string");
console.log("this is a test for string" === "This is a test for string");
var str2 = "This is a for test string";
console.log("this is a for test string" === str2.toLowerCase());
console.log("This Is A for test String" === str2.toLowerCase());
...
if(alien_color == "Green") {
    document.write("You just earned 5 points for shooting the alien. <br>");
} else {
...
var favoriteFruits = ["Apple", "Orange", "Grapes"];
...
let usernames = ["Shakeel", "Mazhar", "Afsar", "Imran", "admin"];
usernames.map((name) => {
  if (name == "admin") {
...
let current_user = ["admin", "manger", "supervisor", "helper", "worker"];
let new_users = ["helper", "fitter", "worker", "cleaner", "tea boy"];

new_users.map((user) => {
  if (current_user.includes(user.toLowerCase())) {
...
let pizza_flavours = ["Chicken Fajita", "Cheesy", "BBQ"]

for (let i = 0; i < pizza_flavours.length; i++) {
    console.log("I like " + pizza_flavours[0] + " pizza");
}

console.log("I really like " + pizza_flavours[0] + " pizza");
console.log("I mostly like " + pizza_flavours[2] + " pizza");
console.log("I sometimes like " + pizza_flavours[1] + " pizza");
...
console.log(animals[0] + " would make even great pet!");
console.log(animals[1] + " would make even great pet!");
console.log(animals[2] + " would make even great pet!");
...
function make_shirt(size, message) {
    console.log("The shirt size is " + size + " the J. " + message);
  }
  
  make_shirt('extra large', 'Eid Collection')
...
function make_shirt2(size = "large", message) {
    if (size == "large" || size == "medium") {
      console.log("The shirt size is " + size + " and I love Javascript");
    } else {
      console.log("The shirt size is " + size + "and"  + message);
    }
  };
  
  make_shirt2("medium", "Eid Collection");
...
function describe_city(name, countryName = "UAE") {
    console.log(name + " is in " + countryName);
  }
  
  describe_city("Dubai");
  describe_city("Sarjah");
...
function make_Album(artistName, albumTitle, numOfTracks = 0) {
    return {
  ...
  console.log(make_Album('Farhan Saeed', 'Sajna', 10));
  console.log(make_Album('Ali Zafar', 'Masty', 12));
  console.log(make_Album('Faakhir', 'Mantra', 13));
...
function ingredientsofSandwich(array) {
    console.log("The person order following ingredients on its sandwich: ");
    array.map((item, index) => {
      console.log(`${index}) ${item}`);
    });
  }
  
  ingredientsofSandwich(["Spread", "Salad"]);
  ingredientsofSandwich(["Meat", "Cheese", "Tomato"]);
  ingredientsofSandwich(["Chicken", "Mayonese", "Lettice", "Tomato"]);
